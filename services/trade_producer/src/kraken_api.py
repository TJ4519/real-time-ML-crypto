...
class KrakenWebsocketTradeAPI:
    ...
    def __init__(self,product_id: str):
        ...
        print("Connecting to the URL: Success")
    ...
    def _likensubscribe(self, product_id: str) :
        ...
        print(f'Now....attempting subscribing to trades for the following pair {product_id} via messasing to websocket')
        msg = {
            "method": "subscribe",
            "params": {
                "channel":"trade",
        ...
        print(f'Success, message subscription live')
    ...
    def get_trades(self) -> List[Dict]:
         ...
         while True:
            ...
            if (message_data.get('channel') == 'trade' 
            and 
            message_data.get('type') == 'update' 
            and 
            'qty' in message_data.get('data', [{}])[0]):  # Ensure data is present and qty is in the first item
